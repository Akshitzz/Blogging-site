    ...
    return (
       <>
        <h1 className="max-md:hidden">Manage Blogs</h1>
            ...
            <InpageNavigation route={["Published Blogs", "Drafts"]}
                ...
                {/*  published blogs */
                    ...
                    <>
                    {
                            blogs.results.map((blog,i)=>{
                                ...
                                <LoadMoreButton state={blogs} fetchData={getBlogs} additionalParam={{draft:false, deletedDocCount:blogs.deletedDocCount}}/>
                 ...
                 {/*  drafts blogs */
                    ...
                    <>
                    {
                            drafts.results.map((blog,i)=>{
                                ...
                                transition={{delay:i *0.04}}
                                >
                                  <ManageDraftBlogCard blog={{...blog, index:i+1,setStateFunc:setDrafts}} index={i+1}/>
                        ...
                        <LoadMoreButton state={drafts} fetchData={getBlogs} additionalParam={{draft:false, deletedDocCount:blogs.deletedDocCount}}/>
