          ...
          if(url){
            axios.post(import.meta.env.VITE_SERVER_DOMAIN + "/update-profile-img",{url},{
                ...
                .then(({data})=>{
                    ...
                    toast.success("Uploaded. Lets go");
                })
                .catch(({response})=>{
                    toast.dismiss(loadingToast);
...
const handleSubmit =(e)=>{
    ...
    let {username, bio,youtube,facebook,twitter,github,instagram,website} = formData;
        ...
        if (username.length <3) {
            return toast.error("Username should be at leat 3 letters long")
        }
                        ...
                        <div className="flex flex-col lg:flex-row items-start py-10 gap-8 lg:gap-10">
                            ...
                            Upload Image
                              ...
                              <img src={profile_img} alt="user profile photo"  ref={profileImgFile}/>
                                ...
                                <button className="btn-light mt-5 max-lg:center lg:w-full px-10" hidden onClick={handleImageUpload} >
                                Upload 
                                </button>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 md:gap-5">
                                ...
                                <textarea name="bio" maxLength={bioLimit} defaultValue={bio} className="input-box h-64 lg:h-40 resize-noe leading-7 mt-5 pl-5" placeholder="Bio" onChange={handleCharacterChange}></textarea>
