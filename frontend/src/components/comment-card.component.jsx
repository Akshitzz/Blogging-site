...
const CommentCard= ({index,leftVal,commentData})=>{
    ...
    let {commented_by:{personal_info:{fullname,profile_img,username:commented_by_username}},commentedAt ,comment,_id,children} = commentData
    
    let { userAuth:{access_token} } = useContext(UserContext);

    let {blog ,blog:{comments,activity,activity:{total_parent_comments},comments:{results:commentArr}} ,author:{personal_info:{username:blog_author}},setBlog ,setTotalParentCommentLoaded } =useContext(BlogContext)
    ...
    const hideReplies = ()=>{
        ...
        const handleReplyClick = ()=>{
            if(!access_token){
                toast.error("Please login to reply to this comment")
                return;
            }
        ...
        <div className="my-5 p-6 rounded-md border border-grey">
            ...
            <div className="flex gap-3 items-center mt-5">
                ...
                <button className="underline" onClick={handleReplyClick}>Reply</button>
                {
                    ...
                    <button className="p-2 px-3 rounded-md border border-grey ml-auto hover:bg-red/30 hover:text-reflex items-center" onClick={deleteComment}>
